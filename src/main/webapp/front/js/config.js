...
var indexNav = [
    ...
    {
        name: '糕点专栏',
        url: './pages/gaodianzhuanlan/list.html'
    },
    {
        name: '每日推荐',
        url: './pages/meirituijain/list.html'
    },
    {
        name: '面食菜谱',
        url: './pages/mianshicaipu/list.html'
    },
    {
        name: '面食文化',
        url: './pages/mianshiwenhua/list.html'
    },
    {
        name: '新闻动态',
...
var adminurl =  "http://localhost:8080/zhongguochuantongmianshijieshao/admin/dist/index.html#/login";
